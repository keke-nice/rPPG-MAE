...
def main(args):
    ...
    if args.reData == 1:
        if args.semi:
            ...
            semi_with = MyDataset.getIndex(fileRoot, semi_withlabel_index, saveRoot + '_1Train50%', 'STMap.png', 5, frames_num)
            semi_without = MyDataset.getIndex(fileRoot, semi_withoutlabel_index, saveRoot + '_2Train50%', 'STMap.png', 5, frames_num)
        else:
    ...
    if args.semi:
        dataset_train = MyDataset.Data_DG(root_dir=(saveRoot + '_Train'+ args.semi),dataName=dataname,STMap1 =args.STMap_name1, STMap2 =args.STMap_name2, \
